...
test_that("AnnotationGx:::.build_pubchem_rest_query", {
  ...
  res2 <- AnnotationGx:::.build_pubchem_rest_query(
    "erlotinib",
    namespace = "name",
    operation = "cids",
    output = "JSON"
  ...
  res3 <- AnnotationGx:::.build_pubchem_rest_query(
    3672,
    namespace = "cid",
    operation = "property/InChIKey",
    output = "JSON"
  )
  expect_class(res3, "httr2_request")

  res4 <- AnnotationGx:::.build_pubchem_rest_query(
    3672,
    namespace = "cid",
    operation = "property/InChIKey",
    output = "JSON",
...
test_that("AnnotationGx:::.build_pubchem_rest_query Failure", {
  ...
  expect_error(AnnotationGx:::.build_pubchem_rest_query(
    c("TRETINOIN", "erlotinib", "TRAMETINIB"),
    domain = "compound",
    namespace = "name",
    operation = "cids",
    output = "JSON"
  ...
  lapply(c("TSV", "PDF", "XLSX"), function(x) {
    expect_error(AnnotationGx:::.build_pubchem_rest_query(2244, output = x))
  })
})
