...
it should only need to be run one. Subsequent look-ups can be done from the
resulting `data.table` based on CID or SID. Make sure to save the failed
...
We have included default parsing function to take the raw query results
for the use cases above and return a well formatted table of results data.
